...
<body class="overflow-x-hidden">
  ...
  <img src="/ricdynamic/V2/img/sideimg.png" alt="" class="hidden md:block absolute right-10 top-32 -z-10" width="600">
  ...
  <div class="line1 flex flex-col justify-center md:flex-row md:justify-around">
    <div class="box border-2 rounded-lg mx-auto mt-12 p-2 w-72 hover:shadow-lg hover:scale-110 cursor-pointer duration-500">
      <div class="outside  hover:rounded-lg p-2 hover:shadow-lg hover:shadow-black">
        <a href="./college.php">
          <div class="lay-1">
            <img src="/ricdynamic/V2/img/mess.png" alt="">
          </div>
    ...
    <div class="box border-2 rounded-lg mx-auto mt-12 p-2 w-72 hover:shadow-lg hover:scale-110 cursor-pointer duration-500">
      <div class="outside  hover:rounded-lg p-2 hover:shadow-lg hover:shadow-black">
        <a href="./hospitals/">
          <div class="lay-1">
            <img src="/ricdynamic/V2/img/hospital.jpg" alt="">
          </div>
          <div class="lay-2 
    ...
    <div class="box border-2 rounded-lg mx-auto mt-12 p-2 w-72 hover:shadow-lg hover:scale-110 cursor-pointer duration-500">
      <div class="outside  hover:rounded-lg p-2 hover:shadow-lg hover:shadow-black">
        <a href="./others.php">
          <div class="lay-1">
            <img src="/ricdynamic/V2/img/entertainment.jpg" alt="">
          </div>
          <div class="lay-2 font-bold text-center  p-2 bg-slate-400 md:bg-slate-200 rounded-lg hover:bg-slate-400">
            ENTERTAINMENT
          </div>
      ...
      <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
        <div class="mb-12 md:mb-0">
          <div class="flex justify-center mb-6">
            <img src="/ricdynamic/V2/profile/ratan.jpeg" class="rounded-full shadow-lg w-32" />
          </div>
        ...
        <div class="mb-12 md:mb-0">
          <div class="flex justify-center mb-6">
            <img src="/ricdynamic/V2/profile/arijit.jpg" class="rounded-full shadow-lg w-32" />
          </div>
        ...
        <div class="mb-0">
          <div class="flex justify-center mb-6">
            <img src="/ricdynamic/V2/profile/niloy.jpeg"  class="rounded-full shadow-lg w-32 " />
          </div>
        ...
        <form action="" method="post">
          <div class="gap-4 justify-center items-center">
            ...
            <div class="md:mb-6 w-full md:w-1/2 mx-auto">
              <input type="email" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 mb-2 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleFormControlInput1" placeholder="Enter your email address" name="email" required />
              <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 mb-3 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleFormControlInput1" placeholder="type your message" name="message" />
            </div>
