  ...
  <nav class="fixed top-0 left-0 bg-white w-full shadow-lg opacity-95" style="font-family: 'Roboto Slab', serif;">
    <div class="container m-auto flex justify-between items-center text-gray-700 w-full">
      ...
      <ul class="hidden md:flex items-center text-base font-semibold cursor-pointer gap-6">
        <li><a href="" class="hover-nav py-3 px-4">Home</a></li>
      ...
      <button class="md:hidden py-3 px-4 mx-2 rounded focus:outline-none group flex flex-col justify-end mr-4 md:mr-0">
        ...
        <div class="absolute top-0 -right-full opacity-0 h-screen w-8/12 bg-white border transform group-focus:right-0 group-focus:opacity-100 transition-all duration-300">
          <ul class="flex flex-col items-center w-full text-base cursor-pointer pt-10">
            <li class="hover:bg-gray-300 py-4 px-6 w-11/12"><a href="">Home</a></li>
