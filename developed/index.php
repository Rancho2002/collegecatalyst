  ...
  <nav class="fixed top-0 left-0 bg-white w-full shadow-lg opacity-95" style="font-family: 'Roboto Slab', serif;">
    <div class="container m-auto flex justify-between items-center text-gray-700 w-full">
      ...
      <ul class="hidden md:flex items-center text-base font-semibold cursor-pointer gap-6">
        ...
        <li><a href="" class="hover-nav hover:text-white py-3 px-4 ">Contact Us</a></li>
      ...
      <button
        class="md:hidden py-3 px-4 mx-2 rounded focus:outline-none hover-nav group flex flex-col justify-end mr-4 md:mr-0">
        ...
        <div
          ...
          <ul class="flex flex-col items-center w-full text-base cursor-pointer pt-10">
            <li class="hover-nav hover:bg-gray-300 py-4 px-6 w-11/12"><a href="">Home</a></li>
            <li class="hover-nav hover:bg-gray-300 py-4 px-6 w-11/12"><a href="">About</a></li>
            <li class="hover-nav hover:bg-gray-300 py-4 px-6 w-11/12"><a href="">Members Area</a></li>
            <li class="hover-nav hover:bg-gray-300 py-4 px-6 w-11/12"><a href="">Contact Us</a></li>
